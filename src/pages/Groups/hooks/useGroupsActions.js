...
import { createGroup, joinGroup, leaveGroup, deleteGroup, updateGroup } from '../services/groupsService';
...
export const useGroupsActions = ({
  ...
  const filteredGroups = useMemo(() => {
    if (searchQuery.length < SEARCH_MIN_LENGTH) return groups;
